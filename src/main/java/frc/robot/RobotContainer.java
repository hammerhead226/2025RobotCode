...
public class RobotContainer {
        ...
        new SelectCommand<>(
            Map.ofEntries(
                Map.entry(
                    ReefHeight.L1,
                    new IntakingAlgae(
                        elevator, csFlywheel, csArm, FieldConstants.ReefHeight.L1, led)),
                Map.entry(
                    ReefHeight.L2,
                    new IntakingAlgae(
                        elevator, csFlywheel, csArm, FieldConstants.ReefHeight.L2, led))),
  ...
  private void configureButtonBindings() {
    ...
    manipController
        .a()
        .onTrue(
            new ReleaseClawParallel(
                FieldConstants.ReefHeight.L1, elevator, csArm, csFlywheel, led));
    manipController
        .b()
        .onTrue(
            new ReleaseClawParallel(
                FieldConstants.ReefHeight.L2, elevator, csArm, csFlywheel, led));
    ...
    driveController
        ...
        .onTrue(
            new ReleaseClawParallel(
                FieldConstants.ReefHeight.L3, elevator, csArm, csFlywheel, led));
    driveController
        .y()
        .onTrue(
            new ReleaseClawParallel(
                FieldConstants.ReefHeight.L4, elevator, csArm, csFlywheel, led));
...
>>>>>>> 11453cb6c40b3c6a109a12962c46c67630e63c22
